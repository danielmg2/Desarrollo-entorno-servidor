...
<body>
    <?php
        ...
        if(isset($_REQUEST["nombreOp"])){
            echo "El nombre opcional es ".$_REQUEST["nombreOp"];
        }
        ...
        // $ubic="/var/www/html/Desarrollo-entorno-servidor/Tema3/Teoria/".basename($_FILES['fichero']['name']);

        // if (move_uploaded_file($_FILES['fichero']['tmp_name'],$ubic)) {
        //     echo "Se movió el fichero a ". $ubic;
        // }else {
        //     echo "Error";
        // }
    ?>

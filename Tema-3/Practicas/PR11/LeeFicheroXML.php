        ...
        if(isset($_REQUEST["Guardar"])){
            ...
            foreach ($nombres as $nombre) {
                if($nombre->nodeValue==$_REQUEST["nombre"]){
                   echo $nombre->nextElementSibling->nodeValue=$_REQUEST["nota1"];
                   echo $nombre->nextElementSibling->nodeValue=$_REQUEST["nota2"];
                   echo $nombre->nextElementSibling->nodeValue=$_REQUEST["nota3"];
                }
            }

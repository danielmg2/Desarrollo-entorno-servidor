...
<body>
    ...
    <div>
        ...
        <br>    
            ...
            <input type="text" id="idcontraseña" name="contraseña" value ="<?php
            ...
            <?php
                if(enviado() &&(validarContraseña($_REQUEST['contraseña'])==0)){
                ?>
            ...
            <br>
            <br>
            <label for="confirmaC">Confirmar Contraseña</label>
            <input type="text" id="idconfirma" name="confirmaC" value ="<?php
                if(enviado() && !vacio("confirmaC")){
                    echo $_REQUEST["confirmaC"];
                }
            ?>">
            <?php
                if(enviado() && ($_REQUEST["confirmaC"]!=$_REQUEST["contraseña"])){
                ?>
                    <span>Contraseña incorrecta o no coincide</span>
                <?php
                }
            ?>
            ...
            <?php             
                ...
                <?php
                    ...
                    $ubi="./imagenes/".basename($_FILES['fich']['name']);
                    
                   ?>
                    <br> 
                    <img src=<?php echo $ubi ?> width="50" height="70">
                    <?php
                }
            ?>
            <br> 

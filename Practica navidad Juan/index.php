            ...
            <div class="row ">
                ...
                ?>
                    ...
                    <div id="recuadro" class="col-3 mt-4 pt-4 text-end ">
                        ...
                        if ($_SESSION == null) {
                        ?>
                            <a class="pe-4" href="./paginas/login.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-in-right text-light" viewBox="0 0 16 16">
                            ...
                            <a href="./paginas/nuevoUSR.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-fill-add text-light" viewBox="0 0 16 16">
    ...
    <footer class="bg-dark text-center text-lg-start">
        ...
        <div class="container p-4">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                <h5 class="text-uppercase text-light">Ayuda:</h5>
                <p class="text-light">
                Tarjetas de regalo
                </p>
                <p class="text-light">
